    ...
    axiosApi
      ...
      .then((res) => {
        ...
        Object.keys(invoiceData).map((key) => {
          ...
          if (key === "invoice_person") uploadData("invoice_person", "");
        ...
        <div className="d-flex col-12 col-md-4 col-xxl-4 flex-column gap-1">
          <div className="row d-flex flex-end">
            <div className="col-md-5">
              <input
                value={invoiceData.sub_total_label}
                onChange={(event) => {
          ...
          <div className="row">
            <div className="col-md-5">
              <input
                value={invoiceData.discount_label}
                onChange={(event) => {
                  uploadData("discount_label", event.target.value);
                }}
                className="col-12 invoice-input my-1 label-start border border-0 p-2"
              />
            </div>
          ...
          <div className="row">
            <div className="col-md-5">
              <input
                value={invoiceData.shipping_label}
                onChange={(event) => {
          ...
          <div className="row">
            <div className="col-md-5">
              <input
                value={invoiceData.amount_paid_label}
                onChange={(event) => {
          ...
          <div className="row">
            <div className="col-md-5">
              <input
                value={invoiceData.balance_due_label}
                onChange={(event) => {
